...
export default defineConfig({
    ...
    resolve: {
        alias: {
            ...
            '@components': resolve(__dirname, 'resources/vue/components'),
            '@templates':  resolve(__dirname, 'resources/vue/components/templates'),
            '@cruds':      resolve(__dirname, 'resources/vue/elements/cruds'),
            '@forms':      resolve(__dirname, 'resources/vue/elements/forms'),
        },
    },
});
