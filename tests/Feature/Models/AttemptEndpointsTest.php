...
class AttemptEndpointsTest extends TestCase
{
    ...
    public function test_attempt_policies_endpoint()
    {
        ...
        $this->json('POST', '/api/attempt/policies', $payload, $headers)
            ->assertStatus(200);
    ...
    public function test_attempt_policy_endpoint()
    {
        ...
        $this->json('POST', '/api/attempt/policy', $payload, $headers)
            ->assertJsonStructure([
                'index'
            ])
            ->assertStatus(200);
    ...
    public function test_attempt_index_auth_endpoint()
    {
        ...
        $this->json('POST', '/api/attempt/index', $payload, $headers)
            ->assertStatus(200);
    ...
    public function test_attempt_show_auth_endpoint()
    {
        ...
        $this->json('POST', '/api/attempt/show', $payload, $headers)
            ->assertStatus(200);
