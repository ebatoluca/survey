...
namespace App\Notifications\SurveyCategory;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\SurveyCategoriesExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new SurveyCategoriesExports($this->request), $this->path, 's3');
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | SurveyCategory export notification';
