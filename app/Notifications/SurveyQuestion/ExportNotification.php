...
namespace App\Notifications\SurveyQuestion;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\SurveyQuestionsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new SurveyQuestionsExports($this->request), $this->path, 's3');
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | SurveyQuestion export notification';
