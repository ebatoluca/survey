...
namespace App\Notifications\SurveyAnswer;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\SurveyAnswersExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new SurveyAnswersExports($this->request), $this->path, 's3');
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | SurveyAnswer export notification';
