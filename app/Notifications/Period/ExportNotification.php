...
namespace App\Notifications\Period;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\PeriodsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new PeriodsExports($this->request), $this->path, 's3');
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Period export notification';
