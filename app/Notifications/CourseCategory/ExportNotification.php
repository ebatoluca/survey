...
namespace App\Notifications\CourseCategory;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\CourseCategoriesExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new CourseCategoriesExports($this->request), $this->path, 's3');
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | CourseCategory export notification';
