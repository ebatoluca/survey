<template>
	...
	<crud-template
		...
		:model="model"
		:external-filters="teacherExternalFilters"
...
<script>
	...
	import FilterForm from '@forms/filters/TeacherFilterForm.vue'
	import * as model from '@js/models/teacher' 
	...
	export default {
		...
		data() {
			...
			return {
				...
				dataUrl: route.name('api.teacher.index'),

				policyUrl: route.name('api.teacher.policies'),
