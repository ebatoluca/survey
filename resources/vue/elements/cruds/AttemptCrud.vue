<template>
	...
	<crud-template
		title="Attempt Administration" 
		:data-url="dataUrl"
		:policy-url="policyUrl"
		:model="model"
		:external-filters="attemptExternalFilters"
...
<script>
	...
	import FilterForm from '@forms/filters/AttemptFilterForm.vue'
	import * as model from '@js/models/attempt' 
	...
	export default {
		...
		data() {
			...
			return {
				...
				dataUrl: route.name('api.attempt.index'),

				policyUrl: route.name('api.attempt.policies'),
