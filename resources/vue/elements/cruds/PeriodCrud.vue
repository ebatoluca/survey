<template>
	...
	<crud-template
		title="Period Administration" 
		:data-url="dataUrl"
		:policy-url="policyUrl"
		:model="model"
		:external-filters="periodExternalFilters"
	...
	export default {
		...
		data() {
			...
			return {
				...
				dataUrl: route.name('api.period.index'),

				policyUrl: route.name('api.period.policies'),
