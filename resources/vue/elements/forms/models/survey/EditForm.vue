        ...
        methods: {
            ...
            fetchSurvey() {
                ...
                axios.post(route.name('api.survey.show'), {
                    ...
                    if(this.fetchSurveyAttempts <= 3) {

                        setTimeout( () => {

                            ++this.fetchSurveyAttempts;
            ...
            onSubmit() {
                ...
                if(this.JSValidator.status) {
                    ...
                    axios.put(route.name('api.survey.update'), {
