...
<script>
	...
	export default {
        ...
        props: {
        	...
        	formId: {
        		type: String,
        		default: 'createSurveyQuestionForm',
        	}
        ...
        methods: {
            ...
            onSubmit() {
                ...
                if(this.JSValidator.status) {
                    ...
                    axios.post(route.name('api.survey_question.create'), {
                        ...
                        this.$emit('submit', {
                            message: 'SurveyQuestion successfully created',
                            res: res
                        });
