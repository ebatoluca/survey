<template>
	...
	<div>
		...
		<div v-if="showTopbar">
			...
			<!-- Header -->
			<div v-if="showTitle" class="uk-container uk-container-expand">
			...
			<div v-if="showBreadcrumb" class="uk-container uk-container-expand">
...
<script>
	...
	import NavDropdownComponent from '@components/dropdowns/NavDropdownComponent.vue'
	import IconRouteComponent from '@components/routes/IconRouteComponent.vue'
	import IconLinkComponent from '@components/links/IconLinkComponent.vue'
	import DisabledLinkComponent from '@components/links/DisabledLinkComponent.vue'
	import DataTableComponent from '@components/tables/DataTableComponent.vue'
	import SelectPaginationComponent from '@components/pagination/SelectPaginationComponent.vue'
