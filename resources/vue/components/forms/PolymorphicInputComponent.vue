...
<script>
	...
	import SingleCheckboxInputComponent from '@components/forms/SingleCheckboxInputComponent.vue'
	import MultiCheckboxInputComponent from '@components/forms/MultiCheckboxInputComponent.vue'
	import EditorInputComponent from '@components/forms/EditorInputComponent.vue'
	import FileInputComponent from '@components/forms/FileInputComponent.vue'
	import FileInfoRow from '@widgets/file/FileInfoRow.vue'
	import RadioInputComponent from '@components/forms/RadioInputComponent.vue'
	import SelectInputComponent from '@components/forms/SelectInputComponent.vue'
	import SimpleFileInputComponent from '@components/forms/SimpleFileInputComponent.vue'
	import StarsInputComponent from '@components/forms/StarsInputComponent.vue'
	import SwitchComponent from '@components/forms/SwitchComponent.vue'
