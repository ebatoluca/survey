...
<script>
	...
	import CreateForm from '@forms/models/course/CreateForm.vue'
	...
	export default {
		...
		methods: {
			...
			fetchCreatePolicy() {
				...
				axios.post(route.name('api.course.policy'), {
			...
			formSubmit(payload) {	
				...
				this.$router.push({name: "AdminShowCourse", params: { id: payload.res.data.id } });
