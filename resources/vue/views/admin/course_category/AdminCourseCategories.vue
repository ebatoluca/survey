<template>
	...
	<div id="AdminCourseCategoriesWrapper">
	...
	export default {
		...
		beforeRouteEnter (to, from, next) {
			...
			next(vue => {
				...
				if(to.name == 'AdminCourseCategories') vue.updateBreadcrumbs();
		...
		watch:{
			...
			'$route.name' (val, oldVal){
				...
				if(val == 'AdminCourseCategories') this.updateBreadcrumbs();
		...
		computed: {
			...
			isHome() {
				...
				return (this.$route.name == 'AdminCourseCategories');
