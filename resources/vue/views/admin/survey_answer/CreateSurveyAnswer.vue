	...
	<div class="uk-section uk-section-xsmall">
		...
		<div class="uk-container uk-container-expand">
			...
			<h3 class="uk-heading-divider">
				...
				<router-link :to="{name: 'AdminSurveyAnswers'}">
	...
	export default {
		...
		methods: {
			...
			fetchCreatePolicy() {
				...
				axios.post(route.name('api.survey_answer.policy'), {
			...
			formSubmit(payload) {	
				...
				this.$router.push({name: "AdminShowSurveyAnswer", params: { id: payload.res.data.id } });
